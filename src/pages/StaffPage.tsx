...
import { Star, Users, Award, Heart, Send, Quote, ChevronRight } from "lucide-react";
...
const StaffPage = () => {
  ...
  const avgRating = totalReviews > 0
    ? (staffReviews!.reduce((s, r) => s + r.rating, 0) / totalReviews).toFixed(1)
    : null;
        ...
        <div className="container mx-auto px-4 pt-28 pb-32 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-6 text-primary-foreground/50 text-lg max-w-xl mx-auto leading-relaxed animate-fade-in">
              Every unforgettable event starts with exceptional people. Get to know the professionals who bring your vision to life.
            </p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {staffMembers.map((staff, idx) => {
              ...
              const isActive = activeCard === staff.user_id;
              const role = roles[idx % roles.length];

              return (
                <div
                  key={staff.id}
                  className="group relative rounded-2xl overflow-hidden bg-card border border-border hover:border-accent/30 transition-all duration-500 hover:shadow-card-hover"
                  onMouseEnter={() => setActiveCard(staff.user_id)}
                  ...
                  <div className="relative aspect-[3/4] bg-muted overflow-hidden">
                    {staff.avatar_url ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-primary/90 to-primary flex items-center justify-center relative">
                        ...
                        <span className="font-display text-7xl font-bold text-accent/80">
                    ...
                    <div className={`absolute bottom-0 left-0 right-0 p-6 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500`}>
                      {canReview && !isRating && (
                        <Button
                          ...
                          onClick={(e) => { e.stopPropagation(); setRatingStaff(staff.user_id); setSelectedRating(0); setComment(""); }}
                        >
                    ...
                    {isRating && (
                      <div className="mt-4 space-y-3 border-t border-border pt-4 animate-fade-in">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button variant="outline" size="sm" className="rounded-full" onClick={() => setRatingStaff(null)}>
                            Cancel
                          </Button>
                        </div>
                      </div>
          ...
          <div className="text-center py-24 max-w-md mx-auto">
            ...
            <p className="text-muted-foreground mt-3 leading-relaxed">
              Our team profiles are being prepared. Check back soon to meet the talented people behind every event.
            </p>
          </div>
        )}
      </section>
        ...
        <section className="bg-primary py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="flex items-end justify-between mb-14">
              ...
              <div className="hidden md:flex items-center gap-2 text-primary-foreground/40 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {staffReviews.slice(0, 6).map((review, idx) => (
                <div
                  key={review.id}
                  className="bg-primary-foreground/5 backdrop-blur-sm rounded-2xl p-8 border border-primary-foreground/10 hover:border-accent/30 transition-all duration-500 group"
                ...
                >
                  ...
                  {review.comment ? (
                    <p className="text-primary-foreground/70 text-sm leading-relaxed line-clamp-4">
                      "{review.comment}"
                    </p>
                  ) : (
      ...
      {!user && (
        <section className="py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center bg-card rounded-3xl p-12 md:p-16 border border-border shadow-card-hover relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mb-8 max-w-md mx-auto">
                  Sign in and complete a booking to share your experience and help others choose the right team.
                </p>
                <a href="/login">
